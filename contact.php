...
<script type="application/ld+json">
{
  ...
  "@type": "ContactPage",
  "name": "Contact AVS Global",
  "url": "https://www.avsglobalsupply.com/contact",
  "mainEntity": {
    "@type": "Organization",
    "name": "AVS Global",
    ...
    <div class="auto-container">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                <div class="content-box">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-8 info-column" style=" margin-top: 30px;">
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <div class="single-item">
                                            <div class="icon-box"><i class="flaticon-location-1"></i></div>
                                            <h6>Address</h6>
                                            <p>Deri OSB Mah. Karadeniz Cad XM-7, Özel Parsel No:21,<br>34956 Tuzla/İstanbul</p>
                                        </div>
                                        <div class="single-item">
                                            <div class="icon-box"><i class="flaticon-time-management"></i></div>
                                            <h6>Off. Hours</h6>
                            ...
                            <div class="info-block-one">
                                <div class="inner-box">
                                    <div class="upper-box">
                                        <div class="light-icon"><i class="flaticon-cityscape"></i></div>
                                        <h3>Greece Office</h3>
                                        <p>Kallithea -  Greece</p>
                                    </div>
                                    <div class="lower-content">
                                        <div class="single-item">
                                            <div class="icon-box"><i class="flaticon-location-1"></i></div>
                                            <h6>Address</h6>
                                            <p>Leof. El. Venizelou 338, Kallithea 176 75, <br />Greece</p>
                                        </div>
                                        <div class="single-item">
                                            <div class="icon-box"><i class="flaticon-time-management"></i></div>
                                            <h6>Off. Hours</h6>
                                        ...
                                        <div class="link">
                                            <a href="https://maps.app.goo.gl/MzDMmgLf9pLx5Hnt7" target="_blank" rel="noopener"><span>View On Map</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
