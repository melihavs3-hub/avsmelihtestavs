<?php 
$title = "Global Ship Supply - AVS";
$description = "";
$canonical ="https://www.avsglobalsupply.com/globalsupply";
$eng_link="https://www.avsglobalsupply.com/globalsupply";
$tr_link="https://www.avsglobalsupply.com/tr/kureselgemitedarigi";
$sri_link="https://www.avssrilanka.com/globalsupply";
$gr_link="https://www.avsgreece.gr/globalsupply";
include 'header.php';
?>
...
<script type="application/ld+json">
{
  ...
  "url": "https://www.avsglobalsupply.com/services/globalsupply",
  "description": "AVS Global offers comprehensive ship supply and marine logistics services at over 1,500 ports worldwide — providing all deck, engine, and cabin stores for global fleets with efficiency and compliance.",
  "provider": {
    "@type": "Organization",
  ...
  "serviceType": "Ship chandlery and marine logistics",
  "areaServed": {
    "@type": "Place",
    "name": "Worldwide"
  },
  "audience": {
    "@type": "Audience",
    "audienceType": "Commercial shipping operators, fleet managers, and marine procurement teams"
  }
}
</script>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="content-one">
                                <figure class="image-box"><img src="assets/images/service/service01.webp" alt="Global Ship Supply"></figure>
                                <div class="text-box">
                                    <h2>Global Ship Supply</h2>
                                    <p class="bold-text">1,500+ ports in 126 countries.</p>
                                    <p>AVS is your comprehensive source for all stores and provisions across 1,500+ ports in 126 countries. Navigate the world with the assurance that wherever your fleet destination; a seamless supply chain will follow. Our Global Supply services promise delivery of all products that are required on board, as well as the peace of mind knowing that your operational needs are met worldwide, efficiently and reliably.</p>
                                </div>
                            </div>
                            <div class="content-three">
                                <div class="inner-box">
                                    <div class="single-item">Global supply services includes remote areas</div>
                                    <div class="single-item">Single point of contact for a comprehensive range of supplies</div>
									<div class="single-item">Convenient payment terms for all supplies in the currency of your choice</div>
									<div class="single-item">Experienced sourcing representative dedicated to each client, assisting all types of vessels and offshore platforms</div>
									<div class="single-item">Advanced reporting dashboard to track and forecast supplies</div>
									<div class="single-item">Assurance of replacing any missing or incorrect items in an order at the next port of call</div>
									<div class="single-item">24/7-365  day service</div>
                                </div>
                            </div>
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab" id="tab-3">
                                            <div class="text-box">
												...
												<p><a href="https://www.avsglobalsupply.com/areas" target="_blank">Countries and Ports We Serve</a></p>
                                            </div>
                                        </div>
                        ...
                        <div class="service-sidebar">
                            <div class="sidebar-widget category-widget">
                                <ul class="category-list clearfix">
                                    <li><a href="https://www.avsglobalsupply.com/globalsupply" class="current"><span>Global Supply</span><i class="flaticon-diagonal-arrow"></i></a></li>
                            ...
                            <div class="download-widget">
                                <ul class="download-list clearfix">
									<li>
										...
										<h5>2024 Brochure</h5>
										<a href="assets/files/avs_2024.pdf"target="_blank"><button type="button"><i class="flaticon-download"></i></button></a>
									</li>
									<li>
										<div class="icon"><i class="avs_jis_dinvalves-pdf"></i></div>
										<h5>JIS & DIN Valves</h5>
										<a href="assets/files/avs_jis_dinvalves.pdf"target="_blank"><button type="button"><i class="flaticon-download"></i></button></a>
									</li>
									<li>
										<div class="icon"><i class="avs_marine_rubber_spareparts-pdf"></i></div>
										<h5>Marine Rubber & S. P.</h5>
										<a href="assets/files/avs_marine_rubber_spareparts.pdf"target="_blank"><button type="button"><i class="flaticon-download"></i></button></a>
									</li>
									<li>
										<div class="icon"><i class="avsropes-pdf"></i></div>
										<h5>Ropes</h5>
										<a href="assets/files/avsropes.pdf"target="_blank"><button type="button"><i class="flaticon-download"></i></button></a>
									</li>
                                </ul>
                            </div>
