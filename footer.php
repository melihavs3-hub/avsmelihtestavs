    ...
    <div class="container auto-container">
        ...
        <div class="newsletter-card">
            <div class="newsletter-info">
                <h3>Stay Anchored</h3>
                <p>Get the latest maritime news and AVS updates directly to your inbox.</p>
            </div>
            <form id="newsletter-form" class="newsletter-form validate">
                <input type="email" name="email" placeholder="Your work email address..." required id="mce-EMAIL">
        ...
        <div class="footer-main-grid">
            ...
            <div class="brand-col">
                ...
                <p>Your global ship supplier operating worldwide, built on a network of 1500+ ports in 126 countries.</p>
                
                <div class="contact-item">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>Soganlik Yeni Mah, Pamukkale Sk. No:2, 34880 <br> Kartal / İstanbul / Türkiye</span>
                </div>
            </div>
            ...
            <div class="footer-col accordion-col">
                ...
                <ul class="footer-links">
                    <li><a href="https://www.avsglobalsupply.com/company">The Company</a></li>
                    <li><a href="https://www.avsglobalsupply.com/timeline">Timeline</a></li>
                    <li><a href="https://www.avsglobalsupply.com/management">Management</a></li>
                    <li><a href="https://www.avsglobalsupply.com/advantage">The AVS Advantage</a></li>
                    <li><a href="https://www.avsglobalsupply.com/glossary">Maritime Glossary</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col accordion-col">
                ...
                <ul class="footer-links">
                    <li><a href="https://www.youtube.com/watch?v=MNta7NWHTpc" target="_blank"><i class="fab fa-youtube text-danger me-2"></i> Onshore Chefs Perfect Lunch</a></li>
                    <li><a href="https://www.youtube.com/watch?v=e27edJ8Dsjc" target="_blank"><i class="fab fa-youtube text-danger me-2"></i> DS Kanuni Team Visiting</a></li>
        ...
        <div class="footer-bottom-wrapper">
            ...
            <div class="footer-copyright">
                <div>© <?php echo date("Y"); ?> <strong style="color: #0b4a7d;">AVS Global Supply</strong>. All rights reserved.</div>
                <div class="legal-links">
                    <a href="https://www.avsglobalsupply.com/partners">Partners</a>
                    <a href="https://www.avsglobalsupply.com/career">Career</a>
                    <a href="https://www.avsglobalsupply.com/contact">Contact</a>
                    <a href="https://www.avsglobalsupply.com/kvkk">KVKK / Privacy Policy</a>
                </div>
            </div>
        </div>
    </div>
...
<button class="fab-to-top" id="backToTopFab" aria-label="Back to Top">
