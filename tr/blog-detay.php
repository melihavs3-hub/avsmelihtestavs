...
$eng_link = "https://www.avsglobalsupply.com/blog";
$tr_link = "https://www.avsglobalsupply.com/tr/blog-detay/$slug";
$gr_link = "https://www.avsgreece.gr/blog";
$sri_link = "https://www.avssrilanka.com/blog";

// API URL'leri
$query = [
    'populate' => 'category,cover,author.avatar',
    'webSites' => 'TR', // website filtresini kullanıyoruz
];

// URL'yi doğru şekilde yapılandırmak için http_build_query kullanıyoruz.
$api_url = "https://avs-cms-5fzbd.ondigitalocean.app/api/articles/$slug?" . http_build_query($query);

$api_url_categories = "https://avs-cms-5fzbd.ondigitalocean.app/api/categories?populate=articles";
...
$canonical    = $articleData['canonical_url'] ?? "https://www.avsglobalsupply.com/blog/$slug";
$author       = $articleData['author']['name'] ?? 'Bilinmiyor';
$cover       = $articleData['cover']['url'] ;
...
// URL'yi doğru şekilde yapılandırmak için http_build_query kullanıyoruz.
$api_url_post = 'https://avs-cms-5fzbd.ondigitalocean.app/api/articles?' . http_build_query($querypost);
                ...
                <div class="blog-details-content">
                    <div class="content-one service-details-page">
                        <div class="author-post">
                            ...
                            <span>Tarih:</span> <?= $formattedDate ?></li></li>
                                <li><span>Yazar:</span> <?= htmlspecialchars($author) ?></li>
                            </ul>
                        </div>
                        <h2><?= htmlspecialchars($title) ?></h2>
                        <div class="text-box blog-image">   <p>
                    ...
                    <div class="author-box">
                        ...
                        <h5><a href="/tr/blog">Tüm Yazılar</a></h5>
                    </div>

                    <!-- Geri butonu -->
                    <div class="post-nav-btn">
                        <div class="btn-box">
                        <a href="https://www.avsglobalsupply.com/tr/blog"><span>← Bloga Geri Dön</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-widget post-widget">
                        ...
                        <div class="post-inner">
                            ...
                            <div class="post">
                                    <figure class="post-thumb"><a href="/tr/blog-detay/<?= $post['slug'] ?>"><img src="<?= $post['cover']['url'] ?>" alt=""></a></figure>
                                    <h6><?= htmlspecialchars($post['category']['name'] ?? '') ?></h6>
                                    <h4><a href="/tr/blog-detay/<?= $post['slug'] ?>"><?= htmlspecialchars($post['title']) ?></a></h4>
                                </div>
                                <?php endforeach; ?>
