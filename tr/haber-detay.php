            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-details-content">
                    ...
                    <div class="author-box">
                        ...
                        <p>This content was written by <?= htmlspecialchars($author) ?>.</p>
                    ...
                    <div class="post-nav-btn">
                        <div class="btn-box">
                            <a href="blog.php"><span>← Haberlere geri dön</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-widget post-widget">
                        <div class="widget-title"><h3>Popüler Haberler</h3></div>
                        <div class="post-inner">
                            ...
                            <div class="post">
                                    ...
                                    <h4><a href="/tr/haber-detay/<?= $post['slug'] ?>"><?= htmlspecialchars($post['title']) ?>"</a></h4>
                                </div>
                                <?php endforeach; ?>
