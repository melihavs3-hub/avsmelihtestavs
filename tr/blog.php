...
$seo_title = "Blog";
$description = "";
$canonical = "https://www.avsglobalsupply.com/blog";
$eng_link = "https://www.avsglobalsupply.com/blog";
$tr_link = "https://www.avsglobalsupply.com/tr/blog";
...
$query = [
    ...
    'sort' => 'publish_date:desc', // Son eklenenler en üstte görünsün
];
    ...
    <div class="auto-container">
                        ...
                        <div class="inner-box">
                            <div class="upper-box">
                                ...
                                <ul class="post-info clearfix">
                                    ...
                                    <li><span>By</span> <?= htmlspecialchars($post['author']['name'] ?? 'Yazar Bilinmiyor') ?></li>
                                </ul>
                            </div>
                            <div class="image-box">
                                <?php if (!empty($post['cover']['url'])): ?>
                                    <figure class="image">
                                        <a href="blog-detay/<?= $post['slug'] ?>">
                                            <img src="<?= $post['cover']['url'] ?>" alt="<?= htmlspecialchars($post['title']) ?>">
                                        </a>
                                    </figure>
                                    <div class="view-btn">
                            ...
                            <div class="lower-box">
                                <h3><a href="blog-detay/<?= $post['slug'] ?>"><?= htmlspecialchars($post['title']) ?></a></h3>
                                <p><?= htmlspecialchars($post['description'] ?? '') ?></p>
                                <div class="link">
                                    <a href="blog-detay/<?= $post['slug'] ?>"><span>Explore More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="pagination-wrapper centred">
            <ul class="pagination clearfix">
                <?php if ($current > 1): ?>
                    <li class="prev-btn">
                        <a href="blog.php?page=<?= $current - 1 ?>&filters=<?= urlencode($filters) ?>">
                ...
                <?php for ($i = 1; $i <= $total; $i++): ?>
                    <li class="count-page">
                        <a href="blog.php?page=<?= $i ?>&filters=<?= urlencode($filters) ?>"
