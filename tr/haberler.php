...
$seo_title = "Haberler";
$description = "";
$canonical = "https://www.avsglobalsupply.com/tr/haberler";
    ...
    <div class="auto-container">
                        ...
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <?php if (!empty($post['cover']['url'])): ?>
                                    <figure class="image">
                                        <a href="/tr/haber-detay/<?= $post['slug'] ?>">
                            ...
                            <div class="lower-box">
                                <h3><a href="/tr/haber-detay/<?= $post['slug'] ?>"><?= htmlspecialchars($post['title']) ?></a>
                                </h3>
                                <p><?= htmlspecialchars($post['description'] ?? '') ?></p>
                                <div class="link">
                                    <a href="/tr/haber-detay/<?= $post['slug'] ?>"><span>Explore More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="pagination-wrapper centred">
            <ul class="pagination clearfix">
                <?php if ($current > 1): ?>
                    <li class="prev-btn">
                        <a href="haberler.php?page=<?= $current - 1 ?>&filters=<?= urlencode($filters) ?>">
                            <i class="flaticon-left-chevron"></i> Önceki Sayfa
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php for ($i = 1; $i <= $total; $i++): ?>
                    <li class="count-page">
                        <a href="haberler.php?page=<?= $i ?>&filters=<?= urlencode($filters) ?>"
                ...
                <?php if ($current < $total): ?>
                    <li class="next-btn">
                        <a href="haberler.php?page=<?= $current + 1 ?>&filters=<?= urlencode($filters) ?>">
                            Sonraki Sayfa <i class="flaticon-right-chevron"></i>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
