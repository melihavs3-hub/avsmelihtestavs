...
<link rel="preload" href="assets/css/all-styles.min.css" as="style">
<link rel="stylesheet" href="assets/css/all-styles.min.css" media="print" onload="this.media='all'">
<noscript><link rel="stylesheet" href="assets/css/all-styles.min.css"></noscript>
        ...
        <div class="outer-container">
            <div class="left-column">
                ...
                <div class="award-box">
                    ...
                    <h5>Your global ship supplier <br />operating worldwide.</h5>
                </div>
            </div>
            ...
            <div class="outer-box">
                ...
                <div class="menu-right-content">
                    <div class="language-box">
                        <h5><img src="assets/images/icons/icon-3.webp" alt="">Global:</h5>
    ...
    <nav class="menu-box">
        ...
        <div class="mobile-quote-inside-menu" style="padding: 15px 20px 0; margin-bottom: 10px;">
            <a href="https://rfq.avsglobalsupply.com" target="_blank" rel="noopener noreferrer" style="background-color: #0b4a7d; color: #ffffff; padding: 12px 15px; border-radius: 4px; font-weight: 600; font-size: 14px; display: flex; align-items: center; justify-content: center; text-decoration: none; width: 100%;">
                <i class="fas fa-file-invoice" style="margin-right: 8px;"></i> Quick Quote
            </a>
        </div>
