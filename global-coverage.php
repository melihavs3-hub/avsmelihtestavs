...
<style>
    ...
    /* GÜNCELLENEN LİSTE AYARLARI: İlk madde hariç diğerlerine tik ekler */
    .popup-content ul { padding-left: 0; margin: 0 0 15px 0; font-size: 13px; color: #444; }
    .popup-content ul li { margin-bottom: 5px; list-style-type: none; position: relative; }
    .popup-content ul li:first-child { margin-bottom: 8px; } /* İlk madde ile diğerleri arasına azıcık boşluk */
    .popup-content ul li:not(:first-child) { padding-left: 18px; }
    .popup-content ul li:not(:first-child)::before { 
        content: "✔"; 
...
<section class="sec-pad">
    <div class="auto-container">
        <div class="sec-title text-center mb-5">
            <span class="sub-title">Where We Serve</span>
            <h2>Global Ship Supply Network</h2>
            <p class="mt-3">AVS Global Supply provides vessel supply services across major ports worldwide. Explore our global coverage and request a quote directly for your vessel.</p>
        </div>
...
<script>
    ...
    const generatePopup = (locationName, country) => `
        <div class="popup-content">
            ...
            <ul>
                <li><strong>Available Vessel Supply</strong></li>
                <li>Provisions</li>
                <li>Bonded Stores</li>
