<?php 
$title = "Food Trading - AVS";
$description = "";
$canonical ="https://www.avsglobalsupply.com/food";
$eng_link = "https://www.avsglobalsupply.com/food";
$tr_link = "https://www.avsglobalsupply.com/tr/gida";
$sri_link="https://www.avssrilanka.com/food";
$gr_link="https://www.avsgreece.gr/food";
include 'header.php';
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Food Trading",
  "description": "Delight in the flavors that the world has to offer without ever leaving your doorstep. Our food trading service isn't just about supplying products; it's about bringing flavors, cultures and traditions to your table. We offer a gateway to a global pantry, ensuring that your business can offer an unparalleled variety of high-quality, delicious food products.",
  "provider": {
    "@type": "Organization",
  ...
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "Food Trading Services",
    "itemListElement": [
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Product",
          "name": "End-to-end Procurement and Purchasing",
          "description": "Comprehensive procurement and purchasing services for your global food trading needs."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Product",
          "name": "Comprehensive Documentation and Certification",
          "description": "Full documentation and certification services to ensure compliance and smooth import/export facilitation."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Product",
          "name": "Efficient Transportation and Logistics",
          "description": "Seamless transportation and logistics services to deliver high-quality food products globally."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Product",
          "name": "Customized Private Label Production",
          "description": "Tailored private label production for unique food products."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Product",
          "name": "Food Trade Consulting",
          "description": "Expert consulting services for optimizing food trading operations."
        }
      }
    ]
  },
  "url": "https://www.rammifood.com"
}
</script>
<style>
...
<!-- page-title -->
        <section class="page-title">
            <div class="bg-layer" style="background-image: url(assets/images/background/10.webp);"></div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="content-one">
                                <figure class="image-box"><img src="assets/images/service/service06.webp" alt="Food Trading"></figure>
                                <div class="text-box">
                                  <h2><?php echo $filename ?> </h2>
                                    <h2>Food Trading</h2>
                                    <p class="bold-text">Global Flavors, Delivered.</p>
                                    <p>Delight in the flavors that the world has to offer without ever leaving your doorstep. Our food trading service isn't just about supplying products; it's about bringing flavors, cultures and traditions to your table. We offer a gateway to a global pantry, ensuring that your business can offer an unparalleled variety of high-quality, delicious food products.</p>
									<br>Satisfying the palate of every customer, while ensuring sustainability, quality, and reliability with every delivery.</br>
							   </div>
                            </div>
                            <div class="content-three">
                                <div class="inner-box">
                                    <div class="single-item">End-to-end procurement and purchasing</div>
                                    <div class="single-item">Comprehensive documentation and certification</div>
									<div class="single-item">Seamless import/export facilitation</div>
									<div class="single-item">Efficient transportation and logistics</div>
									<div class="single-item">Wide-reaching distribution channels</div>
									<div class="single-item">Cutting-edge product research and development</div>
									<div class="single-item">Customized private label production</div>
									<div class="single-item">Food trade consulting</div>
									<li><a href="https://www.rammifood.com" target="_blank" rel="noopener"><span>www.rammifood.com</span></a></li>
                                </div>
                            </div>
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab" id="tab-3">
                                            <div class="text-box">
												...
												<p><a href="https://www.avsglobalsupply.com/areas" target="_blank" rel="noopener">Countries and Ports We Serve</a></p>
                                            </div>
                                        </div>
                        ...
                        <div class="service-sidebar">
                            <div class="sidebar-widget category-widget">
                                <ul class="category-list clearfix">
                                    ...
                                    <li><a href="https://www.avsglobalsupply.com/tsm"><span>Technical Stores Management</span><i class="flaticon-diagonal-arrow"></i></a></li>
									...
									<li><a href="https://www.avsglobalsupply.com/food" class="current"><span>Food Trading</span><i class="flaticon-diagonal-arrow"></i></a></li>
									<li><a href="https://www.avsglobalsupply.com/logistics"><span>Logistics Services</span><i class="flaticon-diagonal-arrow"></i></a></li>
									<li><a href="https://www.avsglobalsupply.com/education"><span>Seafarer Education</span><i class="flaticon-diagonal-arrow"></i></a></li>
                                </ul>
                            </div>
...
<link rel="alternate" hreflang="en" href="<?php echo $eng_link ?? 'https://www.avsglobalsupply.com/' . $currentFileWithoutExt; ?>"/>
